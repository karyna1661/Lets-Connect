...
export function DevconnectEventCard() {
  const frontContent = (
    ...
    >
      ...
      <p className="text-sm text-gray-600 mb-4">Bangkok 2024</p>
  ...
  const backContent = (
    ...
    >
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center text-center">
        {/* Coming Soon Badge */}
        <div className="w-20 h-20 mx-auto rounded-full bg-black flex items-center justify-center shadow-lg mb-4">
